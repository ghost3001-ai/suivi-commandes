...
class Config:
    ...
    DASHBOARD_PURCHASE_BUDGET = float(os.environ.get('DASHBOARD_PURCHASE_BUDGET') or 0)
    DASHBOARD_BUDGET_WARNING_PCT = float(os.environ.get('DASHBOARD_BUDGET_WARNING_PCT') or 85)
    DASHBOARD_NEGOTIATION_ALERT_THRESHOLD = float(os.environ.get('DASHBOARD_NEGOTIATION_ALERT_THRESHOLD') or 10)
    DASHBOARD_SUPPLIER_DEPENDENCY_THRESHOLD = float(os.environ.get('DASHBOARD_SUPPLIER_DEPENDENCY_THRESHOLD') or 35)
